...
var targetUser = "pieub5odgkvu0zxhqce8"; // account username
var targetPass = "YMVJ0HZBYA59417"; // account password
var apiKey = "CA5B4F1E4BBCF78865DE8FC6DA49B60A"; // Steam dev api ke. Google steam api key
var pDelay = 17.674; // don't mess with this unless you know what it does.
var debug = 0; // 1 = on ; 0 = off
var targetID = "Wiene"; // ID to turbo.
// ---- [Only Change the information between the quotes] ---- //
